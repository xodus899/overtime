...
describe 'navigate' do
  ...
  describe "new" do
    it 'has a link from the homepage' do
      employee = Employee.create(first_name: "employee", last_name: "why", email: "wonderbread@example.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "1234567891" )
  ...
  describe "delete" do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, work_performed: "Work Performed", user_id: delete_user.id, daily_hours: 3.5)
